...
import {KpiByLaborUnionService} from './kpi-by-laborunion.service'
import {CustomDatepickerI18n, I18n} from "../../shared/datepicker-i18n";
import {NgbDatepickerI18n} from "@ng-bootstrap/ng-bootstrap";


@Component({
    selector: 'jhi-kpi-by-laborunion',
    templateUrl: './kpi-by-laborunion.component.html',
    providers: [I18n, {provide: NgbDatepickerI18n, useClass: CustomDatepickerI18n}]
})
export class KpiByLaborUnionComponent implements OnInit, OnDestroy {
    currentAccount: any;
    error: any;
    success: any;
    ...
    constructor(private kpiByLaborUnionService: KpiByLaborUnionService,
    ...
    ngOnInit(): void {
        ...
        this.kpiByLaborUnionService.recentTime().subscribe(
   ...
   export() {
        this.kpiByLaborUnionService.export({
            query: {
                day: this.day,
                laborUnionId: this.labor,
                date: this.regDate.year + "-" + this.regDate.month + "-" + this.regDate.day,
