...
public class RSATest {
	...
	public static void main(String[] args) {
		String str = "ssy123456";
        String enStr = RSA.encryptByPublic(str);
//		String enStr = "RrfFqYTr9NHAkqeX4bFn1J4ihXPNXxKYEKbRceU9ABJzUHufioCtz3N1DkEjIta3atNENRCdOo9xzPf8B5/Jtp2zCyUoB9onBg4mu+U9h+FApR26hGAYPE1Yf3k4MQv21A2ENU8ju6UCdB6W9huv9n3OqWBeFNo7QqbT+N+OKJQ=";
        System.out.println("公钥加密后：" + enStr);
        String deStr = RSA.decryptByPrivate(enStr);
